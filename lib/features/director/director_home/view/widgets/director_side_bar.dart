...
class DirectorSideBar extends StatefulWidget {
  const DirectorSideBar({super.key});
...
class _DirectorSideBarState extends State<DirectorSideBar> {
  ...
  void _onSectionTap(int idx, _SectionEntry sec, bool isMobile) {
    final ctrl = DirectorController.instance;
    final currentlySelected = ctrl.selectedIndex.value == idx;

    final currentPath =
        GoRouter.of(context).routeInformationProvider.value.uri.path;
    final onDetails = currentPath
            .startsWith('${AppRoutesNew.directorBase}/activity/') ||
        currentPath
            .startsWith('${AppRoutesNew.directorBase}/plan-implementation/');
...
void _showSettings(BuildContext context, bool isMobile) {
  ...
  final directorCtrl = DirectorController.instance;
