...
import 'package:opms/features/manger/manager_home/view/widgets/manager_side_bar.dart';
...
class ManagerShell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: isMobile ? const ManagerSideBar() : null,
          ...
          Expanded(
            child: Row(
              children: [
                ...
                if (!isMobile) const ManagerSideBar(),
