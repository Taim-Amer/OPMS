...
class ManagerPlanRegionsPanel extends StatelessWidget {
  final int planActivityId; // pass it down from parent

  const ManagerPlanRegionsPanel({super.key, required this.planActivityId});

  @override
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final ctrl =
        Get.put(ManagerActivityPlanDetailsController(), tag: "$planActivityId");
          ...
          Row(
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  try {
                    final isEditable = Get.find<ManagerActivityPlanDetailsController>(
                            tag: "$planActivityID")
                        .isPlanEditable
                        .value;
                    context.goNamed(
                      ...
                      pathParameters: {
                        'planActivityId':
                            Get.find<ManagerActivityPlanDetailsController>(
                                    tag: "$planActivityID")
                                .planActivityId
                                .toString(),
