...
class ManagerActivityPlanDetailsModel {
  final bool status;
  final ActivityPlanData? data;
  final String? message;
  final List<dynamic>? meta;

  ManagerActivityPlanDetailsModel({
  ...
  factory ManagerActivityPlanDetailsModel.fromJson(Map<String, dynamic> json) {
    return ManagerActivityPlanDetailsModel(
