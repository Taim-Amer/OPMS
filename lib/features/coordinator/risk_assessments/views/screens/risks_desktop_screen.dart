...
class RisksDesktopScreen extends GetView<GovernorateController> {
  const RisksDesktopScreen({super.key});
                    ...
                    Expanded(
                      ...
                      child: StaggeredGrid.count(
                        ...
                        children: List.generate(
                          controller.riskModel.data?.length ?? 0,
                            ...
                            //     mainAxisCellCount: index.isEven ? 0.4 : 0.45,
                              ...
                              child: Skeletonizer(
                                enabled: controller.getRiskState == RequestState.loading || controller.riskModel.data == null || !Get.isRegistered<GovernorateController>(),
                                child: RisksItem(
                                  risk: controller.riskModel.data?[index],
                                ),
                              ),
                            ),
                          ),
