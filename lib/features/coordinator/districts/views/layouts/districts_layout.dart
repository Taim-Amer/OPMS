...
class DistrictsLayout extends StatelessWidget {
  const DistrictsLayout({super.key, required this.fromAnother});
  ...
  Widget build(BuildContext context) {
    return TSiteTemplate(
      useLayout: false,
      desktop: DistrictsDesktopScreen(fromAnother: fromAnother,),
      tablet: DistrictsDesktopScreen(fromAnother: fromAnother,),
      mobile: DistrictsDesktopScreen(fromAnother: fromAnother,),
    );
  }
}
