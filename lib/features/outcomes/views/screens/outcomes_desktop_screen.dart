...
import 'package:opms/features/outcomes/views/widgets/insert_outcome_container.dart';
...
class OutcomesDesktopScreen extends StatelessWidget {
  const OutcomesDesktopScreen({super.key, required this.fromAnother});
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(
                    flex: 3,
                    child: GetBuilder<OutcomesController>(
                      builder: (controller) {
                        return Skeletonizer(
                          ...
                          child: TPaginatedDataTable(
                            ...
                            columns: [
                              ...
                              // DataColumn(label: TextWidget(text: 'Outputs List'.s14w700, color: TColors.white)),
                            ],
                          ),
                        );
                      },
