...
class SingInMobile extends GetView<SignInController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Padding(
        padding:
            const EdgeInsets.symmetric(horizontal: Sizes.secondaryPaddingSpace),
        child: Center(
          child: SizedBox(
            width: 550,
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          'Welcome to the Red Crescent Management System'
                              .s17w700(context),
                          Sizes.sm.verticalSpace,
                          'Please sign in to access your dashboard and manage operations efficiently.'
                              .s17w400(context),
                        ],
                      ),
                    ),
                    ...
                    Column(
                      children: [
                        ...
                        LabeledTextFeild(
                          ...
                          isPassword: true,
                          validator: (value) =>
                              Validator.minimumValidator(value, minimum: 6),
                        ),
                        Sizes.spaceBtwItems.verticalSpace,
                        GetBuilder<SignInController>(
                            builder: (controller) => SizedBox(
                                  ...
                                  child: CustomButton(
                                    title: 'Login',
                                    isLoading: controller.loginState ==
