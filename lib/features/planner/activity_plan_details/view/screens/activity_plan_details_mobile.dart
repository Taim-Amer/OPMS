// lib/features/planner/activity_plan_details/view/layouts/activity_plan_details_mobile.dart
...
class ActivityPlanDetailsMobile extends StatelessWidget {
  final ActivityPlanData data;

  const ActivityPlanDetailsMobile({
    Key? key,
    required this.data,
  }) : super(key: key);
