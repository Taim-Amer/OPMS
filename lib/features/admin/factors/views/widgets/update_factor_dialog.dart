...
class UpdateFactorDialog extends GetView<FactorsController> {
  const UpdateFactorDialog({super.key, required this.factorID});
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    'Update factor title from here'.s17w700,
                    Sizes.spaceBtwSections.verticalSpace,
                    LabeledTextFeild(
                      label: '',
                      controller: controller.updateFactorTitleController,
                      hint: 'Factor Title',
                      validator: (value) => Validator.validateEmptyText('factor title', value),
                    ),
                    Sizes.spaceBtwItems.verticalSpace,
                    GetBuilder<FactorsController>(
                        builder: (controller) => SizedBox(
                          width: double.infinity,
                          child: CustomButton(
                            title: 'Update',
                            isLoading: controller.updateFactorsState.value == RequestState.loading,
                            onTap: () => controller.updateFactor(factorID: factorID),
                          ),
                        ),
                    ),
                  ],
