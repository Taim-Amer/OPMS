...
class GeneralRepoImpl implements GeneralRepo{
  ...
  @override
  Future<DataState<MessageModel>> addRoleToUser({required int roleID, required int userID, required List<int> departmentIDs, required List<int> unitsIDs}) async {
  ...
  @override
  Future<DataState<ActivitiesModel>> getActivities(int? outputID) async{
    return await _apiService.postData(
  ...
  Future<DataState<RolesModel>> getRoles() async{
    return await _apiService.getData(endPoint: ApiConstants.roles, fromJson: RolesModel.fromJson);
  }

  @override
  Future<DataState<UnitsModel>> getUnits(int? departmentID) async{
    return await _apiService.getData(
      endPoint: ApiConstants.units,
      queryParameters: {
        'department_id' : departmentID
      },
      fromJson: UnitsModel.fromJson,
    );
  }
  ...
  @override
  Future<DataState<MessageModel>> insertActivity({required int outputID, required String name, required int code}) async {
    return await _apiService.postData(
      endPoint: ApiConstants.activities,
      data: {
        'output_id' : outputID,
  ...
  @override
  Future<DataState<MessageModel>> insertDepartment({required String name, required int code}) async{
    return await _apiService.postData(
      endPoint: ApiConstants.departments,
      data: {
        'name' : name,
  ...
  @override
  Future<DataState<MessageModel>> insertIndicator({required int outputID, required String name}) async{
    return await _apiService.postData(
      endPoint: ApiConstants.indicators,
      data: {
        'output_id' : outputID,
  ...
  @override
  Future<DataState<MessageModel>> insertUnit({required int departmentID, required String name, required String type, required int code}) async{
    return await _apiService.postData(
      endPoint: ApiConstants.units,
      data: {
        'department_id' : departmentID,
  ...
  @override
  Future<DataState<MessageModel>> insertUser({required String name, required String email, required String password, required String passwordConfirm}) async{
    return await _apiService.postData(
      endPoint: ApiConstants.users,
      data: {
        'name' : name,
  ...
  @override
  Future<DataState<LoginModel>> login({required String email, required String password}) async{
    return await _apiService.postData(
  ...
  @override
  Future<DataState<MessageModel>> updateDepartment({required int departmentID, String? name, int? code}) async{
    return await _apiService.putData(
  ...
  @override
  Future<DataState<MessageModel>> updateRole({required int roleID, required String name}) async{
    return await _apiService.putData(
  ...
  @override
  Future<DataState<MessageModel>> updateUser({required int userID, required String name, required String email, required String password, required String passwordConfirm, required String method}) async{
    return await _apiService.putData(
